...
\begin{enumerate}
  \item To define tobacco field boundaries through interactive polygon drawing. 
  \item To classify tobacco crop health. 
  \item To flag declining crop health. 
  \item To generate heat maps that identify crop stress hotspots.
\end{enumerate}
